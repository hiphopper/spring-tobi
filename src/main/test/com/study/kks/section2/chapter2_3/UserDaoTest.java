...
public class UserDaoTest {
    ...
    public void addAndGet() throws SQLException{
        ApplicationContext applicationContext = new GenericXmlApplicationContext("applicationContext_2_3.xml");
    ...
    public void getCount() throws SQLException{
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("applicationContext_2_3.xml");
        UserDao userDao = applicationContext.getBean("userDao", UserDao.class);
